...
const TomorrowPriceChart = () => {
    ...
    const getPriceTomorrow = async () => {
        try {
            const res = await client.get("api/data/price-tomorrow")
  ...
  return (
    ...
    {loading ? 
    <View style={{ margin:20, marginBottom:140,}}>
      <Text style={{textAlign: 'center', fontSize:18, marginTop:20,}}>TOMORROW</Text>
...
export default TomorrowPriceChart;