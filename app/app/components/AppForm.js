...
export default function AppForm({ navigation }) {
  ...
  const loginColorInterpolate = animation.interpolate({
    inputRange: [0, width],
    outputRange: ['rgba(98, 181, 245, 1)', 'rgba(98, 181, 245, 0.4)'],
  });
  const signupColorInterpolate = animation.interpolate({
    inputRange: [0, width],
    outputRange: ['rgba(98, 181, 245, 0.4)', 'rgba(98, 181, 245, 1)'],
  });
  ...
  />
    ...
    <View style={{ backgroundColor:'rgba(255, 241, 232, 0.8)', marginTop:230, borderRadius:90, height:1000,  }}>
